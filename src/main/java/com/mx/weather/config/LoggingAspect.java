...
public class LoggingAspect {
	 ...
	 */
	@Pointcut("within(com.mx.weather.service..*) "
		+ " || within(com.mx.weather.controller..*)")
	...
	private boolean isPrintable(ProceedingJoinPoint joinPoint) {
		String className = this.getClassName(joinPoint);
		String pkge = joinPoint.getSignature().getDeclaringTypeName();
